...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#f6fef9]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -left-24 top-10 w-md h-112 bg-[#00803E]/10 rounded-full blur-3xl" />
        <div className="absolute -right-32 bottom-0 w-120 h-120 bg-[#079AE1]/12 rounded-full blur-3xl" />
